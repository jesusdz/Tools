...
set GCC=%TOOLCHAIN%\bin\%TARGET%-clang
set GXX=%TOOLCHAIN%\bin\%TARGET%-clang++
...
echo %GCC% -march=armv8-a  -fPIC -c %NATIVE_APP_GLUE_DIR%\android_native_app_glue.c -o android_native_app_glue.o
call %GCC% -march=armv8-a  -fPIC -c %NATIVE_APP_GLUE_DIR%\android_native_app_glue.c -o android_native_app_glue.o
...
echo %GXX% -I%NATIVE_APP_GLUE_DIR% -march=armv8-a --sysroot=%TOOLCHAIN%\sysroot -std=gnu++11 -fPIC -c ..\jni\main.cpp -o main.o
call %GXX% -I%NATIVE_APP_GLUE_DIR% -march=armv8-a --sysroot=%TOOLCHAIN%\sysroot -std=gnu++11 -fPIC -c ..\jni\main.cpp -o main.o

echo %GXX% main.o -L. -landroid_native_app_glue -landroid -lEGL -lGLESv1_CM -llog -shared -o ..\lib\arm64-v8a\libgame.so
call %GXX% main.o -L. -landroid_native_app_glue -landroid -lEGL -lGLESv1_CM -llog -shared -o ..\lib\arm64-v8a\libgame.so
...
call %BUILD_TOOLS%\aapt add bin\NativeActivity.unaligned.apk lib\arm64-v8a\libgame.so

copy "%TOOLCHAIN_LIB_DIR%\libc++_shared.so" lib\arm64-v8a\
call %BUILD_TOOLS%\aapt add bin\NativeActivity.unaligned.apk "lib\arm64-v8a\libc++_shared.so"

REM mkdir lib\arm64 2>nul
REM copy lib\arm64-v8a\*.* lib\arm64
...
REM copy "%TOOLCHAIN_LIB_DIR%\33\libc++.so" lib\arm64-v8a\
REM call %BUILD_TOOLS%\aapt add bin\NativeActivity.unaligned.apk "lib\arm64-v8a\libc++.so"
REM copy "%TOOLCHAIN_LIB_DIR%\33\libandroid.so" lib\arm64-v8a\
REM call %BUILD_TOOLS%\aapt add bin\NativeActivity.unaligned.apk "lib\arm64-v8a\libandroid.so"
REM copy "%TOOLCHAIN_LIB_DIR%\33\liblog.so" lib\arm64-v8a\
REM call %BUILD_TOOLS%\aapt add bin\NativeActivity.unaligned.apk "lib\arm64-v8a\liblog.so"
REM copy "%TOOLCHAIN_LIB_DIR%\33\libEGL.so" lib\arm64-v8a\
REM call %BUILD_TOOLS%\aapt add bin\NativeActivity.unaligned.apk "lib\arm64-v8a\libEGL.so"
REM copy "%TOOLCHAIN_LIB_DIR%\33\libGLESv1_CM.so" lib\arm64-v8a\
REM call %BUILD_TOOLS%\aapt add bin\NativeActivity.unaligned.apk "lib\arm64-v8a\libGLESv1_CM.so"
